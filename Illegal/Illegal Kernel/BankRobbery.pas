...
implementation
  ...
  constructor TBankRobbery.Create( aOwner : TTeam; aMetaMission : TMetaServerMission );
    begin
      inherited;
    end;
      ...
      case Hacker1Result of
        1:
          begin
            ...
            Charges.Values['LeaderCharge1'] := 'InformaticCrime';
  ...
  procedure TBankRobbery.InTheBank(Diff : single);
    ...
    begin
      ...
      Charges.Values['LeaderCharge2'] := 'BankRobbery';
  ...
  procedure TBankRobbery.OpenVaultExpl(Diff : single);
    ...
    begin
      ...
      Charges.Values['LeaderCharge2'] := 'BankRobberyWithSafeWreckage';
      Charges.Values['PoliceDiff2'] := IntToStr(500);
        ...
        case IllSystem.UseSkill(Hacker2.SkillVal, Diff) of
          1:
            begin
              ...
              Charges.Values['LeaderCharge2'] := 'BankRobberyWithSafeHacking';
              Charges.Values['PoliceDiff2'] := IntToStr(500);
              Charges.Values['Underground2'] := IntToStr(100);
              Charges.Values['Witness2'] := IntToStr(200);
              Charges.Values['Forensic2'] := IntToStr(100);
          ...
          case IllSystem.UseSkill(Gorilla.SkillVal, Diff) of
            ...
            3:
              begin
                ...
                Charges.Values['PoliceDiff3'] := 'Charge2';
      ...
      case IllSystem.UseSkill(Crim.Skill, Diff) of
        1:
          begin
            ...
            Charges.Values['PoliceDiff4'] := 'Charge2';
            Result := True;
          end;
        2:
          begin
      ...
      for i := 1 to 8 do
        ...
        then
          begin
            ...
            IllSystem.GiveChargesToCriminal(crim.Name);
            IllSystem.CriminalArrested(crim.Name);
          end;
    end;
