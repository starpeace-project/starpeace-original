...
implementation
  ...
  constructor TMetaMineBlock.Create(anId            : string;
                                    aCapacities     : array of TFluidValue;
                                    aLegalServMax   : TFluidValue;
                                    aCompMax        : TFluidValue;
                                    aChemicalMax    : TFluidValue;
    ...
    begin
      ...
      MetaOutputs.Insert(
        TMetaOutput.Create(
          ...
          TPullOutput,
          TMetaFluid(TheClassStorage.ClassById[tidClassFamily_Fluids, tidFluid_Ore]),
          5,
          [mgoptCacheable, mgoptEditable],
          sizeof(Sample.fOre),
  ...
  procedure RegisterBackup;
    begin
      BackupInterfaces.RegisterClass(TMineBlock);
    end;
