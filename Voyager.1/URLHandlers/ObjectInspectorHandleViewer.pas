...
uses
  ...
  StdCtrls, VisualClassesHandler, InternationalizerComponent;
...
implementation
  ...
  uses
    Collection, ActiveX, SheetHandlerRegistry, SyncObjs, SmartThreads, CacheCommon,
