...
interface
  ...
  uses
    VoyagerInterfaces, Classes, IniClasses, Controls, VisualClassManager;
...
implementation
  ...
  procedure TVisualClassesHandler.setMasterURLHandler( URLHandler : IMasterURLHandler );
    begin
