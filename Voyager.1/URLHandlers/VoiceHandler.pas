...
interface
  ...
  uses
    VoyagerInterfaces, VoyagerServerInterfaces, Classes, Controls, MPlayer, ExtCtrls, StarVoice, VoicePanelViewer;
...
implementation
  ...
  procedure TVoiceHandler.setMasterURLHandler( URLHandler : IMasterURLHandler );
    begin
