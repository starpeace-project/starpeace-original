  ...
  procedure TLander.RenderSnapshot(const view : IGameView; const ClipRect : TRect; snap : TCanvasImage);
    ...
    procedure DrawLandLayers(x, y, i, j : integer);
      ...
      procedure DrawRank(x, i, j : integer);
        ...
        procedure CalcIterationValues(i, j, Size : integer; out sc, ec, deltac, sr, er, deltar : integer; out colinouterloop : boolean);
          begin
            case rotation of
              drNorth:
                begin
        ...
        procedure StartOuterLoop(colinouterloop : boolean; sc, sr : integer; out c, r : integer);
          begin
            if colinouterloop
              then c := sc
              else r := sr;
        ...
        function CheckOuterLoopCond(colinouterloop : boolean; c, r, ec, er : integer) : boolean;
          begin
            if colinouterloop
              then Result := c <> ec
              else Result := r <> er;
        ...
        procedure DoOuterLoopStep(colinouterloop : boolean; var c, r : integer; deltac, deltar : integer);
          begin
            if colinouterloop
              then inc(c, deltac)
              else inc(r, deltar);
        ...
        procedure StartInnerLoop(colinouterloop : boolean; sc, sr : integer; out c, r : integer);
          begin
        ...
        function CheckInnerLoopCond(colinouterloop : boolean; c, r, ec, er : integer) : boolean;
          begin
            if not colinouterloop
              then Result := c <> ec
              else Result := r <> er;
        ...
        procedure DoInnerLoopStep(colinouterloop : boolean; var c, r : integer; deltac, deltar : integer);
          begin
            if not colinouterloop
              then inc(c, deltac)
              else inc(r, deltar);
