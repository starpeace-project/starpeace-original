...
implementation
  ...
  constructor TTimerTicker.Create;
    begin
      inherited;
      fTickeables := TInterfaceList.Create;
                ...
                if CurTickeable.Enabled
                  then
                    try
                      ...
                      {$ifopt d+}
                         Outputdebugstring('TTimerTicker.TimerTick');
                      {$endif}
                    end;
              end;
