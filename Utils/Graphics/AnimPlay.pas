    ...
    TAnimDecoder =
      class
        protected
          ...
          function  GetFrameDelay : longint;                                                   virtual; abstract;
        ...
        public
          ...
          property FrameDelay : longint        read GetFrameDelay;
        ...
        public
          ...
          procedure SeekFrame( FrameIndx : integer );
...
implementation
  ...
  procedure TAnimDecoder.SeekFrame( FrameIndx : integer );
    begin
      assert( FrameIndx <= FrameCount, 'Invalid frame index in AnimPlay.TAnimDecoder.SeekFrame!!' );
      if FrameIndx < CurrentFrameIndx
        then
          begin
            SeekStart;
            fCurrentFrame := Stream.RelockFrame( fCurrentFrame );
          end;
