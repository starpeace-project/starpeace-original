...
interface
  ...
  uses
    Windows, DirectDraw, Direct3D, {Limits,} D3DXErr;
  ...
  function D3DXPrepareDeviceForSprite(const d3dDevice : IDirect3DDevice7; ZEnable : BOOL) : HRESULT; cdecl; external 'd3dx.dll' name '_D3DXPrepareDeviceForSprite';
  ...
  function D3DXDrawSpriteSimple(const d3dTexture : IDirectDrawSurface7;
                                ...
                                ppointDest : PD3DXVECTOR3;
                                alpha,
                                scale,
                                angleRad : single;
                                pOffset : PD3DXVECTOR2;
                                pSourceRect : PRect) : HRESULT; cdecl; external 'd3dx.dll' name '_D3DXDrawSpriteSimple';
  ...
  function D3DXDrawSpriteTransform(const d3dTexture : IDirectDrawSurface7;
                                   const d3dDevice : IDirect3DDevice7;
                                   pMatrixTransform  : PD3DXMATRIX;
                                   alpha : single;
                                   pSourceRect : PRect) : HRESULT; cdecl; external 'd3dx.dll' name '_D3DXDrawSpriteTransform';
  ...
  procedure D3DXBuildSpriteTransform(pMatrix : PD3DXMATRIX;
                                     const rectDest : TRect;
                                     angleRad : single;
                                     pOffset : PD3DXVECTOR2); cdecl; external 'd3dx.dll' name '_D3DXBuildSpriteTransform';
  ...
  type
    TVectorQuad = array [0..3] of TD3DXVECTOR4;

  function D3DXDrawSprite3D(const d3dTexture : IDirectDrawSurface7;
                            const d3dDevice : IDirect3DDevice7;
                            quad : TVectorQuad;
                            alpha : single;
                            pSourceRect : PRect) : HRESULT; cdecl; external 'd3dx.dll' name '_D3DXDrawSprite3D';
