...
LPSTR)    StrFormatByteSizeA(DWORD dw, LPSTR szBuf, UINT uiBufSize);
LPWSTR)   StrFormatByteSizeW(DWORD dw, LPWSTR szBuf, UINT uiBufSize);
int)      StrFromTimeIntervalA(LPSTR pszOut, UINT cchMax, DWORD dwTimeMS, int digits);
int)      StrFromTimeIntervalW(LPWSTR pszOut, UINT cchMax, DWORD dwTimeMS, int digits);
...
BOOL)     StrToIntExW(LPCWSTR pszString, DWORD dwFlags, int FAR * piRet);
...
LWSTDAPI_(BOOL)     PathMakeSystemFolderA(LPSTR pszPath);
LWSTDAPI_(BOOL)     PathMakeSystemFolderW(LPWSTR pszPath);
LWSTDAPI_(BOOL)     PathUnmakeSystemFolderA(LPSTR pszPath);
LWSTDAPI_(BOOL)     PathUnmakeSystemFolderW(LPWSTR pszPath);
LWSTDAPI_(BOOL)     PathIsSystemFolderA(LPSTR pszPath, DWORD dwAttrb);
LWSTDAPI_(BOOL)     PathIsSystemFolderW(LPWSTR pszPath, DWORD dwAttrb);
