...
/***    PFNOPEN  - File I/O callbacks for FCI
 *      PFNREAD
 *      PFNWRITE
 *      PFNCLOSE
 *      PFNSEEK
 ...
 *      You can write wrapper routines to allow FCI to work on memory
 ...
 *      seek position.  Your PFNREAD and PFNWRITE functions will do 
 *      memcopy(), and update the seek position in your "handle" structure.  
 *      PFNSEEK will just change the seek position in your "handle" 
 *      structure.
 */
