...
interface
  ...
  {$ELSE}
  function DecompressCabFiles( CabFile : string; DestDir : string; UserData : pointer; Notifier : TDecompressNotifier ) : BOOL;
  {$ENDIF}
...

{
  ...
  function DecompressCabFiles( CabFile : string; DestDir : string; UserData : pointer; Notifier : TDecompressNotifier ) : BOOL;
    ...
    begin
      ...
      fillchar( PI, sizeof(SI), 0 );
      SI.cb := sizeof(SI);
      SI.wShowWindow := SW_HIDE;
      cmdLine := 'cabarc.exe -o -p x ' + CabFile + ' ' + DestDir;
