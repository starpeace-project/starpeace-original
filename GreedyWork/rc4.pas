  ...
  type
    TRC4 =
      class
        ...
        public
          property Key : string read fStrKey write SetKey;
      end;
        ...
        then
          begin
            ...
            for lLngIndex := 0 To 255 do
    	      fBytKeyAry[lLngIndex] := byte(pStrKey[lLngIndex mod lLngKeyLength]);
          end;
    end;
          ...
          begin
            ...
            for lLngX := 1 To len do
              begin
                ...
                lBytJump  := (lBytJump + fBytCypherAry[lBytIndex]) mod 256; // ' wrap J+S()

                // Add/Wrap those two
                lLngT := (fBytCypherAry[lBytIndex] + fBytCypherAry[lBytJump]) mod 256;

                // Switcheroo
                lBytTemp := fBytCypherAry[lBytIndex];
                fBytCypherAry[lBytIndex] := fBytCypherAry[lBytJump];
                fBytCypherAry[lBytJump]  := lBytTemp;
                lBytY := fBytCypherAry[lLngT];
