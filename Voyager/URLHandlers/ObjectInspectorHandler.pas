...
interface
  ...
  uses
    ...
    ObjectInspectorHandleViewer, VCLUtils;
...
implementation
  ...
  procedure TObjectInpectorHandler.setMasterURLHandler( const URLHandler : IMasterURLHandler );
    begin
      fMasterURLHandler := URLHandler;
      fControl.MasterURLHandler := URLHandler;
      URLHandler.HandleEvent( evnAnswerClientView, fClientView );
      fControl.InitSheetContainer(fClientView);
    end;
