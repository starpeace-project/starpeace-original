...
// File generated on 4/22/2001 4:40:38 AM from Type Library described below.
...
// *********************************************************************//
  ...
  TInternetExplorerWindowSetResizable = procedure(Sender: TObject; Resizable: WordBool) of object;
  TInternetExplorerWindowSetLeft = procedure(Sender: TObject; Left: Integer) of object;
  TInternetExplorerWindowSetTop = procedure(Sender: TObject; Top: Integer) of object;
  TInternetExplorerWindowSetWidth = procedure(Sender: TObject; Width: Integer) of object;
  TInternetExplorerWindowSetHeight = procedure(Sender: TObject; Height: Integer) of object;
  TInternetExplorerWindowClosing = procedure(Sender: TObject; IsChildWindow: WordBool; 
                                                              var Cancel: OleVariant) of object;
  TInternetExplorerClientToHostWindow = procedure(Sender: TObject; var CX: OleVariant;
                                                                   var CY: OleVariant) of object;
  TInternetExplorerSetSecureLockIcon = procedure(Sender: TObject; SecureLockIcon: Integer) of object;
  TInternetExplorerFileDownload = procedure(Sender: TObject; var Cancel: OleVariant) of object;
...
// *********************************************************************//
  ...
  TShellNameSpaceFavoritesSelectionChange = procedure(Sender: TObject; cItems: Integer; 
                                                                       hItem: Integer; 
...
begin
  case DispID of
   ...
   108: if Assigned(FOnProgressChange) then
            FOnProgressChange(Self, Params[0] {Integer}, Params[1] {Integer});
   105: if Assigned(FOnCommandStateChange) then
            FOnCommandStateChange(Self, Params[0] {Integer}, Params[1] {WordBool});
   ...
   250: if Assigned(FOnBeforeNavigate2) then
            FOnBeforeNavigate2(Self, Params[0] {const IDispatch}, Params[1] {var OleVariant}, Params[2] {var OleVariant}, Params[3] {var OleVariant}, Params[4] {var OleVariant}, Params[5] {var OleVariant}, Params[6] {var WordBool});
   ...
   252: if Assigned(FOnNavigateComplete2) then
            FOnNavigateComplete2(Self, Params[0] {const IDispatch}, Params[1] {var OleVariant});
   259: if Assigned(FOnDocumentComplete) then
            FOnDocumentComplete(Self, Params[0] {const IDispatch}, Params[1] {var OleVariant});
   ...
   263: if Assigned(FOnWindowClosing) then
            FOnWindowClosing(Self, Params[0] {WordBool}, Params[1] {var WordBool});
   268: if Assigned(FOnClientToHostWindow) then
            FOnClientToHostWindow(Self, Params[0] {var Integer}, Params[1] {var Integer});
   269: if Assigned(FOnSetSecureLockIcon) then
            FOnSetSecureLockIcon(Self, Params[0] {Integer});
   270: if Assigned(FOnFileDownload) then
            FOnFileDownload(Self, Params[0] {var WordBool});
  end; {case DispID}
end;
...
function TShellUIHelperProperties.GetDefaultInterface: IShellUIHelper;
begin
  Result := FServer.DefaultInterface;
end;
...
begin
  case DispID of
   ...
   1: if Assigned(FOnFavoritesSelectionChange) then
            FOnFavoritesSelectionChange(Self, Params[0] {Integer}, Params[1] {Integer}, Params[2] {const WideString}, Params[3] {const WideString}, Params[4] {Integer}, Params[5] {const WideString}, Params[6] {Integer});
...
begin
  Result := DefaultInterface.Get_SubscriptionsEnabled;
end;

function  TShellNameSpace.Get_EnumOptions: Integer;
begin
  Result := DefaultInterface.Get_EnumOptions;
end;
...
begin
  Result := DefaultInterface.Get_Depth;
end;
...
begin
  Result := DefaultInterface.Get_TVFlags;
end;
...
begin
  DefaultInterface.Set_Columns(bstrColumns);
end;

function  TShellNameSpace.Get_CountViewTypes: SYSINT;
begin
  Result := DefaultInterface.Get_CountViewTypes;
end;
...
begin
  ...
  RegisterComponents('ActiveX',[TInternetExplorer, TShellWindows, TShellUIHelper, TShellNameSpace]);
end;
