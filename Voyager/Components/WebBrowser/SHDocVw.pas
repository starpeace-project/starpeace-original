...
interface
  ...
  type
    ...
    IWebBrowser =
      interface(IDispatch) ['{EAB22AC1-30C1-11CF-A7EB-0000C05BAE0B}']
  ...
  { DispInterface declaration for Dual Interface IWebBrowser }
    ...
    IWebBrowserDisp =
      dispinterface ['{EAB22AC1-30C1-11CF-A7EB-0000C05BAE0B}']
  ...
  { Web Browser Control Events (old) }
    ...
    DWebBrowserEvents =
      dispinterface ['{EAB22AC2-30C1-11CF-A7EB-0000C05BAE0B}']
  ...
  { Web Browser Application Interface. }
    ...
    IWebBrowserApp =
      interface(IWebBrowser) ['{0002DF05-0000-0000-C000-000000000046}']
  ...
  { DispInterface declaration for Dual Interface IWebBrowserApp }
    ...
    IWebBrowserAppDisp =
      dispinterface ['{0002DF05-0000-0000-C000-000000000046}']
        procedure GoBack; dispid 100;
        procedure GoForward; dispid 101;
        procedure GoHome; dispid 102;
        procedure GoSearch; dispid 103;
  ...
  { Web Browser Interface for IE4. }
    ...
    IWebBrowser2 =
      interface(IWebBrowserApp) ['{D30C1661-CDAF-11D0-8A3E-00C04FC9E26E}']
  ...
  { DispInterface declaration for Dual Interface IWebBrowser2 }
    ...
    IWebBrowser2Disp =
      dispinterface ['{D30C1661-CDAF-11D0-8A3E-00C04FC9E26E}']
        procedure GoBack; dispid 100;
        procedure GoForward; dispid 101;
        procedure GoHome; dispid 102;
        procedure GoSearch; dispid 103;
    ...
    DWebBrowserEvents2 =
      dispinterface ['{34A715A0-6587-11D0-924A-0020AFC7AC4D}']
        procedure StatusTextChange(const Text: WideString); dispid 102;
        procedure ProgressChange(Progress, ProgressMax: Integer); dispid 108;
        procedure CommandStateChange(Command: Integer; Enable: WordBool); dispid 105;
        procedure DownloadBegin; dispid 106;
  ...
  { Folder View Events Forwarder Object }
    ...
    IFolderViewOC =
      interface(IDispatch) ['{9BA05970-F6A8-11CF-A442-00A0C90A8F39}']
  ...
  { DispInterface declaration for Dual Interface IFolderViewOC }
    ...
    IFolderViewOCDisp =
      dispinterface ['{9BA05970-F6A8-11CF-A442-00A0C90A8F39}']
  ...
  { Event interface for ShellFolderView }
    ...
    DShellFolderViewEvents =
      dispinterface ['{62112AA2-EBE4-11CF-A5FB-0020AFE7292D}']
  ...
  { Event interface for IShellWindows }
    ...
    DShellWindowsEvents =
      dispinterface ['{FE4106E0-399A-11D0-A48C-00A0C90A8F39}']
  ...
  { Definition of interface IShellWindows }
    ...
    IShellWindows =
      interface(IDispatch) ['{85CB6900-4D95-11CF-960C-0080C7F4EE85}']
  ...
  { DispInterface declaration for Dual Interface IShellWindows }
    ...
    IShellWindowsDisp =
      dispinterface ['{85CB6900-4D95-11CF-960C-0080C7F4EE85}']
        ...
        function FindWindow(var pvarloc, pvarlocRoot: OleVariant; swClass: SYSINT; out pHWND: Integer; swfwOptions: SYSINT): IDispatch;
  ...
  { Definition of Shell Link IDispatch interface }
    ...
    IShellLinkDual =
      interface(IDispatch) ['{88A05C00-F000-11CE-8350-444553540000}']
        function Get_Path: WideString; safecall;
    ...
    IShellLinkDualDisp =
      dispinterface ['{88A05C00-F000-11CE-8350-444553540000}']
        property Path: WideString;
        property Description: WideString;
        property WorkingDirectory: WideString;
        property Arguments: WideString;
        property Hotkey: SYSINT;
        property ShowCommand: SYSINT;
        procedure Resolve(fFlags: SYSINT);
        function GetIconLocation(out pbs: WideString): SYSINT;
        procedure SetIconLocation(const bs: WideString; iIcon: SYSINT);
        procedure Save(vWhere: OleVariant);
      end;

    { Definition of interface FolderItemVerb }

    FolderItemVerb =
      interface(IDispatch) ['{08EC3E00-50B0-11CF-960C-0080C7F4EE85}']
        function Get_Application: IDispatch; safecall;
        function Get_Parent: IDispatch; safecall;
        function Get_Name: WideString; safecall;
    ...
    FolderItemVerbDisp =
      dispinterface ['{08EC3E00-50B0-11CF-960C-0080C7F4EE85}']
        property Application: IDispatch readonly;
        property Parent: IDispatch readonly;
        property Name: WideString readonly dispid 0;
        procedure DoIt;
      end;
  ...
  { Definition of interface FolderItemVerbs }
    ...
    FolderItemVerbs =
      interface(IDispatch) ['{1F8352C0-50B0-11CF-960C-0080C7F4EE85}']
        function Get_Count: Integer; safecall;
        function Get_Application: IDispatch; safecall;
        function Get_Parent: IDispatch; safecall;
  ...
  { DispInterface declaration for Dual Interface FolderItemVerbs }
    ...
    FolderItemVerbsDisp =
      dispinterface ['{1F8352C0-50B0-11CF-960C-0080C7F4EE85}']
        property Count: Integer readonly;
        property Application: IDispatch readonly;
        property Parent: IDispatch readonly;
        function Item(index: OleVariant): FolderItemVerb;
        function _NewEnum: IUnknown; dispid -4;
      end;
  ...
  { Definition of interface Folder }
    ...
    Folder =
      interface(IDispatch) ['{BBCBDE60-C3FF-11CE-8350-444553540000}']
  ...
  { DispInterface declaration for Dual Interface Folder }
    ...
    FolderDisp =
      dispinterface ['{BBCBDE60-C3FF-11CE-8350-444553540000}']
        property Title: WideString readonly dispid 0;
        property Application: IDispatch readonly;
        property Parent: IDispatch readonly;
        property ParentFolder: Folder readonly;
        function Items: FolderItems;
        function ParseName(const bName: WideString): FolderItem;
        procedure NewFolder(const bName: WideString; vOptions: OleVariant);
        procedure MoveHere(vItem, vOptions: OleVariant);
        procedure CopyHere(vItem, vOptions: OleVariant);
        function GetDetailsOf(vItem: OleVariant; iColumn: SYSINT): WideString;
      end;

  { Definition of interface FolderItems }

    FolderItems =
      interface(IDispatch) ['{744129E0-CBE5-11CE-8350-444553540000}']
        function Get_Count: Integer; safecall;
        function Get_Application: IDispatch; safecall;
        function Get_Parent: IDispatch; safecall;
  ...
  { DispInterface declaration for Dual Interface FolderItems }
    ...
    FolderItemsDisp =
      dispinterface ['{744129E0-CBE5-11CE-8350-444553540000}']
        property Count: Integer readonly;
        property Application: IDispatch readonly;
        property Parent: IDispatch readonly;
        function Item(index: OleVariant): FolderItem;
        function _NewEnum: IUnknown; dispid -4;
      end;
  ...
  { Definition of interface FolderItem }
    ...
    FolderItem =
      interface(IDispatch) ['{FAC32C80-CBE4-11CE-8350-444553540000}']
        function Get_Application: IDispatch; safecall;
        function Get_Parent: IDispatch; safecall;
        function Get_Name: WideString; safecall;
  ...
  { DispInterface declaration for Dual Interface FolderItem }
    ...
    FolderItemDisp =
      dispinterface ['{FAC32C80-CBE4-11CE-8350-444553540000}']
        property Application: IDispatch readonly;
        property Parent: IDispatch readonly;
        property Name: WideString dispid 0;
        property Path: WideString readonly;
        property GetLink: IDispatch readonly;
        property GetFolder: IDispatch readonly;
        property IsLink: WordBool readonly;
        property IsFolder: WordBool readonly;
        property IsFileSystem: WordBool readonly;
        property IsBrowsable: WordBool readonly;
        property ModifyDate: TDateTime;
        property Size: Integer readonly;
        property Type_: WideString readonly;
        function Verbs: FolderItemVerbs;
        procedure InvokeVerb(vVerb: OleVariant);
      end;

  { definition of interface IShellFolderViewDual }

    IShellFolderViewDual =
      interface(IDispatch) ['{E7A1AF80-4D96-11CF-960C-0080C7F4EE85}']
        function Get_Application: IDispatch; safecall;
        function Get_Parent: IDispatch; safecall;
  ...
  { DispInterface declaration for Dual Interface IShellFolderViewDual }
    ...
    IShellFolderViewDualDisp =
      dispinterface ['{E7A1AF80-4D96-11CF-960C-0080C7F4EE85}']
        property Application: IDispatch readonly;
        property Parent: IDispatch readonly;
        property Folder: Folder readonly;
        function SelectedItems: FolderItems;
        property FocusedItem: FolderItem readonly;
        procedure SelectItem(var pvfi: OleVariant; dwFlags: SYSINT);
        function PopupItemMenu(const pfi: FolderItem; vx, vy: OleVariant): WideString;
        property Script: IDispatch readonly;
        property ViewOptions: Integer readonly;
      end;

  { Definition of interface IShellDispatch }

    IShellDispatch =
      interface(IDispatch) ['{D8F015C0-C278-11CE-A49E-444553540000}']
        function Get_Application: IDispatch; safecall;
        function Get_Parent: IDispatch; safecall;
  ...
  { DispInterface declaration for Dual Interface IShellDispatch }
    ...
    IShellDispatchDisp =
      dispinterface ['{D8F015C0-C278-11CE-A49E-444553540000}']
        property Application: IDispatch readonly;
        property Parent: IDispatch readonly;
        function NameSpace(vDir: OleVariant): Folder;
        function BrowseForFolder(HWND: Integer; const Title: WideString; Options: Integer; RootFolder: OleVariant): Folder;
  ...
  { Shell UI Helper Control Interface }
    ...
    IShellUIHelper =
      interface(IDispatch) ['{729FE2F8-1EA8-11D1-8F85-00C04FC2FBE1}']
  ...
  { DispInterface declaration for Dual Interface IShellUIHelper }
    ...
    IShellUIHelperDisp =
      dispinterface ['{729FE2F8-1EA8-11D1-8F85-00C04FC2FBE1}']
  ...
  { Shell Folder View Events Router. }
    ...
    TShellFolderViewOC =
      class(TOleControl)
        ...
        public
          procedure SetFolderView(pDisp: IDispatch);
          property ControlInterface: IFolderViewOC read FIntf;
        published
...
implementation
  ...
  procedure TShellFolderViewOC.InitControlInterface(const Obj: IUnknown);
    begin
      FIntf := Obj as IFolderViewOC;
    end;
