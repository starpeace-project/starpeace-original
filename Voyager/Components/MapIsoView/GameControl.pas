...
implementation
  ...
  procedure TCustomGameControl.QueryViewUpdate(Defer : boolean);
    begin
      QueryUpdate(true);
    end;
  ...
  procedure TCustomGameControl.UpdateZone;
    begin
      ClientRect;
    end;
    ...
    begin
     ...
     // UpdateThroughFocus;
      if fExposed
        then
          begin
            fFocus.QueryViewUpdate(true); //QueryUpdate(true);
            ...
            if fExposed
              then
                begin
                  ...
                  if fFocus = nil
                    then fFocus := fDocument.CreateFocus(Self);
                end
              else
                begin
                  //fFocus := nil;
  ...
  procedure TCustomGameControl.CMMouseLeave(var Message: TMessage);
    begin
      inherited;
      fFocus.MouseLeave;
    end;
