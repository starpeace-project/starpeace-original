...
{ MODs/Erweiterungen as:
 - DirectInputCreateEx (nix da mit A/W)
 - IDirectInput7 (A/W, angefangen)
 - (einziger) neuer Strukturtyp: c_df_DIMouse2

BTW, "Delphi 3 internal Error with IIDs: [...]"  gilt auch für D4
}
...
type
  ...
  IDirectInput7A = interface (IDirectInput2A)
    ...
    function CreateDeviceEx(const rguid, riid: TGUID; var lplpDirectInputDevice:
        IDirectInputDeviceA; pUnkOuter: IUnknown) : HResult;  stdcall;
  end;
...
var
  ...
  DirectInputCreateEx : function (hinst: THandle; dwVersion: DWORD;
      const refIID: TGUID;
      out ppDI: IDirectInput;
      punkOuter: IUnknown) : HResult; stdcall;
