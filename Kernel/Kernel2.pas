  ...
  type
    ...
    TCompany =
      class( TMoneyDealer )
        ...
        public
          procedure DeclareInvention(Kind : string; Invention : TInvention);
        public
          procedure GenMoney( Money : TMoney; Reason : TMoneyReason ); override;
        public
          procedure Loaded; override;
...
implementation
  ...
  procedure TMetaFacility.RequiresInvention(Invention : TInvention);
    begin
      Reqs := SimHints.GetHintText( hidTechRequired, [Invention.Name, Invention.Resp] );
    end;
  ...
  procedure TBlock.LoadFromBackup( Reader : IBackupReader );
    ...
    begin
      inherited;
      //fMetaBlock := TMetaBlock(TheClassStorage.ClassById[tidClassFamily_Blocks, Reader.ReadClass( 'MetaBlock', '' )]);
  ...
  procedure TBlock.StoreToBackup( Writer : IBackupWriter );
    ...
    begin
      inherited;
      Writer.WriteClass( 'MetaBlock', fMetaBlock.Id );
  ...
  procedure TInput.LoadFromBackup( Reader : IBackupReader );
    ...
    begin
      inherited;
      //MetaInputId := Reader.ReadClass( 'MetaInput', '' );
  ...
  procedure TInput.StoreToBackup( Writer : IBackupWriter );
    begin
      inherited;
      Writer.WriteClass( 'MetaInput', fMetaInput.Name );
  ...
  procedure TOutput.LoadFromBackup( Reader : IBackupReader );
    ...
    begin
      inherited;
      //MetaOutputId := Reader.ReadClass( 'MetaOutput', '' );
  ...
  procedure TOutput.StoreToBackup( Writer : IBackupWriter );
    begin
      inherited;
      Writer.WriteClass( 'MetaOutput', fMetaOutput.Name );
...

{
    procedure LoadInventions;
      ...
      begin
        ...
        for i := 0 to pred(count) do
          begin
            InventionId := Reader.ReadClass( 'Invention.' + IntToStr(i), '' );
            try
              Invention := TInvention(TheClassStorage.ClassById[tidClassFamily_Inventions, InventionId]);
              if Invention <> nil
                then
    ...
    procedure StoreInventions;
      ...
      begin
        ...
        for i := 0 to pred(fInventions.Count) do
          Writer.WriteClass( 'Invention.' + IntToStr(i), TInvention(fInventions[i]).Id );
      end;
  ...
  procedure TCompany.DeclareInvention(Kind : string; Invention : TInvention);
    var
      R : TCompanyResearch;
    begin
      R := Research[Kind];
