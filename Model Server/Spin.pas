...
Forms, Graphics, Menus, Buttons, Variants;
const
...
property DownNumGlyphs: TNumGlyphs read GetDownNumGlyphs write
SetDownNumGlyphs default 1;
property DragCursor;
property DragMode;
property Enabled;
...
property UpNumGlyphs: TNumGlyphs read GetUpNumGlyphs write
SetUpNumGlyphs default 1;
property Visible;
...
public
destructor Destroy; override;
property TimeBtnState: TTimeBtnState read FTimeBtnState write
FTimeBtnState;
end;
procedure Register;
implementation
...
begin
FFocusedButton.TimeBtnState := FFocusedButton.TimeBtnState +
[tbFocusRect];
...
FButton.SetBounds(Width - FButton.Width - 5, 0, FButton.Width,
Height - 5)
else FButton.SetBounds (Width - FButton.Width, 1, FButton.Width,
Height - 3);
SetEditRect;
end;
end;
...
procedure TTimerSpeedButton.MouseDown(Button: TMouseButton; Shift:
TShiftState;
X, Y: Integer);
begin
...
procedure TTimerSpeedButton.MouseUp(Button: TMouseButton; Shift:
TShiftState;
X, Y: Integer);
begin
