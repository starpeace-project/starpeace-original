...
implementation
    ...
    begin
      ...
      with fControl do
        begin
          ...
          LoadCache(ClientView.getWorldURL);
          ConnectToWorld(ClientView);
          Parent    := MainPanel;
      ...
      UpdateURLHandler(fControl.Manager);
  ...
  procedure TFiveMainForm.KeyPress(var key : char);
    ...
    begin
      ...
      case upcase(key) of
        'B':
          //fControl.StartFacilityBuild('', 1242);
          fControl.StartFacilityBuild('', 1232);
        'C':
        ...
        'S':
          fControl.ShowSurface('test', ssOver, Slice(SurfaceScale[random(3)], 2));
        'A':
      ...
      case key of
        ...
        VK_F12:
          if OptionsForm.ShowModal = mrOk
            then
              begin
                fControl.AnimateBuildings := OptionsForm.AnimateBuildings.Checked;
                fControl.GlassBuildings := OptionsForm.GlassBuildings.Checked;
                fControl.AnimateLand := OptionsForm.AnimateLand.Checked;
                fControl.CarsEnabled := OptionsForm.CarsEnabled.Checked;
                fControl.PlanesEnabled := OptionsForm.PlanesEnabled.Checked;
                fControl.SoundsEnabled := OptionsForm.SoundsEnabled.Checked;
              end;
      end;
    end;
