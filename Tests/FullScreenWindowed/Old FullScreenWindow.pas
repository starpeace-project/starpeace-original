...
implementation
          ...
          begin
            ...
            if fWindowCount = 0
              then
                ...
                begin
                  fPrimary.SetClipper(fClipper);
                  fPrimary.Blt(nil, fBackBuffer, nil, DDBLT_WAIT, nil);
                end;
          end
  ...
  procedure TFullScreenForm.WindowOpened;
    begin
      inc(fWindowCount);
      LogThis('Window opened called. Now window count is ' + IntToStr(fWindowCount) + '.');
    end;

  procedure TFullScreenForm.WindowClosed;
    begin
      dec(fWindowCount);
      LogThis('Window closed called. Now window count is ' + IntToStr(fWindowCount) + '.');
    end;
