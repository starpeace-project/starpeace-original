...
interface
  ...
  const
    ...
    input_ComputingIndustry_LegalServices = 0.600000023841858;
    ...
    input_LegalServices_ComputerServices = 1.5;
    ...
    input_Refinery_Oil = RefineryFact*1000;
    input_Refinery_Chemicals = RefineryFact*50;
    ...
    output_Refinery_Gasoline = RefineryFact*2000;
