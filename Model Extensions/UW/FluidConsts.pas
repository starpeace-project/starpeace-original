...
interface
  ...
  const
    ...
    cost_ComputingIndustry = 5000000;
    budget_ComputingIndustry = 250;
    ...
    output_ComputerServices = 5;


    // Moab Business Machines
    cost_BusinessMachines = 40000000;
    budget_BusinessMachines = 700;
    input_BusinessMachines_Metal = 130;
    input_BusinessMachines_Electroniccomponents = 225;
    input_BusinessMachines_Chemicals = 40;
    input_BusinessMachines_ExecutivesWorkForce = 12;
    ...
    input_CarIndustry_LegalServices = 0.300000011920929;
    ...
    input_Clothing_Chemicals = 18;
    input_Clothing_ExecutivesWorkForce = 7;
    ...
    budget_HouseHoldingAppliances = 1000;
    ...
    // Moab Legal Services
    cost_LegalServices = 6000000;
    budget_LegalServices = 1700;
