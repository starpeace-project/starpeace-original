  ...
  IllegalGamblingPlace in '..\..\Illegal\Illegal Kernel\IllegalGamblingPlace.pas',
  BackupObjects in '..\..\Persistence\BackupObjects.pas',
  BuildingDestroy in '..\..\Illegal\Illegal Kernel\BuildingDestroy.pas';
...
//Creator in '..\..\Illegal\Illegal Kernel\Creator.pas';
    ...
    procedure RegisterModelExtension;             
      ...
      begin
        ...
        RoadDestroy.RegisterBackup;
        BuildingDestroy.RegisterBackup;
        ...
        classId := 'Mission1:BuildingDestroy';
        MisLean := TMetaServerMission.Create(classID, 'Destroy Building', 'The team will demolish a commercial or industrial building, at night when nobody is around', 'One-shot', cBuildingDestroyOptions, TBuildingDestroy);
        MisLean.Register('Mission');
        classId := 'Mission2:GamblingPlace';
        MisLean := TMetaServerMission.Create(classID, 'Gambling Place', 'The team will run a illegal gambling place', 'On-Going', 2, TMission);
        MisLean.Register('Mission');
        classId := 'Mission3:DestroyRoad';
        MisLean := TMetaServerMission.Create(classID, 'Destroy Road', 'The team will destroy a square of road', 'One-Shot', cRoadDestroyOptions, TRoadDestroy);
        MisLean.Register('Mission');
        ...
        ChargeLean := TMetaCharge.Create(classID, 'VandalizationWithExplosives', 30, 3, 120, 10000, 8760, 17520, 20000 );
        ChargeLean.Register('Charge');
        ...
        CrimLean := TMetaCriminal.Create(classId, 'Steve McQueen', 'leadertype', 5, 35, CrimSkills, 'Male');
        ...
        CrimLean := TMetaCriminal.Create(classId, 'Joe Pena', 'youngguy', 1, 17, CrimSkills, 'Male');
        CrimLean.Register('Criminal');
        ...
        CrimLean := TMetaCriminal.Create(classId, 'Jane Linux', 'blacklady', 1, 21, CrimSkills, 'Female');
        CrimLean.Register('Criminal');
        ...
        CrimLean := TMetaCriminal.Create(classId, 'Kaiser Sose', 'badass1', 4, 32, CrimSkills, 'Male');
        CrimLean.Register('Criminal');
        ...
        CrimLean := TMetaCriminal.Create(classId, 'Mata Hari', 'oldlady', 2, 25, CrimSkills, 'Female');
        CrimLean.Register('Criminal');
        ...
        CrimSkills.Values['Forgery'] := 'No';
        CrimSkills.Values['Stability'] := '70';
        CrimLean := TMetaCriminal.Create(classId, 'Steven Pidity', 'blackguy', 1, 16, CrimSkills, 'Male');
        CrimLean.Register('Criminal');
        ...
        CrimLean := TMetaCriminal.Create(classId, 'Billy The Kid', 'muscletype', 3, 19, CrimSkills, 'Male');
        CrimLean.Register('Criminal');
        ...
        CrimSkills.Values['Forgery'] := 'No';
        CrimSkills.Values['Stability'] := '80';
        CrimLean := TMetaCriminal.Create(classId, 'girltype', 'Jane Brown', 1, 35, CrimSkills, 'Female');
        CrimLean.Register('Criminal');
        ...
        CrimLean := TMetaCriminal.Create(classId, 'Crazy Joe', 'muscletype2', 1, 21, CrimSkills, 'Male');
        CrimLean.Register('Criminal');
        ...
        CrimSkills.Values['Forgery'] := 'No';
        CrimSkills.Values['Stability'] := '40';
        CrimLean := TMetaCriminal.Create(classId, 'Stupid Bill', 'blackguy2', 1, 22, CrimSkills, 'Male');
        CrimLean.Register('Criminal');
        ...
        CrimLean := TMetaCriminal.Create(classId, 'Idiot Ben', 'drivertype', 1, 23, CrimSkills, 'Male');
        CrimLean.Register('Criminal');
        ...
        CrimSkills.Values['Forgery'] := 'No';
        CrimSkills.Values['Stability'] := '40';
        CrimLean := TMetaCriminal.Create(classId, 'Homer Simpsons', 'oldguy', 1, 45, CrimSkills, 'Male');
        CrimLean.Register('Criminal');
      ...
      begin
        ...
        if WorldLoaded
          then
            begin
              WorldLean := World;
              IllSystem := TIllegalSystem(World.WorldExtension[tidRDOHook_IB]);
              IllSystem.Start;
            end
          else
            begin
